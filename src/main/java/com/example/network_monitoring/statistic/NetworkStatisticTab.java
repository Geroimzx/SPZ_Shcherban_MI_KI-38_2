...
/**
 * Клас NetworkStatisticTab представляє графік використання мережі, який відображає використання мережі у вигляді RX та TX байтів на часовому проміжку а статистику мережі.
