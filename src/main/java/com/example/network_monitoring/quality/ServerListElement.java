...
/**
 * Елемент списку серверів, що використовується для моніторингу якості мережевого з'єднання.
 */
public class ServerListElement {
    ...
    /**
     * Перерахування, що визначає можливі значення якості з’єднання з сервером
     */
